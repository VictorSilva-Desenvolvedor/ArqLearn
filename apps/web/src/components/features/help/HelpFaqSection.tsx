...
const faqEntries: FaqEntry[] = [
  {
    ...
    answer:
      "Cada resposta errada custa 1 vida. Sem vidas, você não consegue começar uma nova lição. Elas se regeneram sozinhas, 1 a cada 3 horas, até o teto de 5 — ou você pode restaurar todas na hora com gemas, clicando no ícone de coração no topo.",
  },
  {
