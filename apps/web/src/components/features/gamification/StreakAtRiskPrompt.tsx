...
// ainda não praticou nem usou o bloqueio (streak_at_risk continuaria true até lá). Sem checar
// isResolved (não exposto em AuthContextValue aqui): AuthProvider já segura `children` — onde
// este componente é montado, ver app/layout.tsx — atrás de um loading até a sessão resolver, tanto
// pra sessão real quanto pra mockada (ver `shouldWait` em contexts/AuthContext.tsx).
