...
// vidas_restantes/xp_ganho), o componente de quiz só exibe o resultado. Vive só enquanto o app
// está aberto. Espelha apps/web/src/lib/api/mocks/fixtures/quizSessions.ts.
