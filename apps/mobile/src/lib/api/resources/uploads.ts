...
import { completeUploadMock, getUploadStatusMock, registerUploadMock } from "../mocks/fixtures/uploadProcessing";
import type { Paginated, UploadedContent, UploadFileType } from "@/types/api";

// Espelha apps/web/src/lib/api/resources/uploads.ts — exceto listUploadQuestions/
// reviewUploadQuestion (revisão de professor, fora de escopo do mobile por decisão já registrada
// em Docs/PENDENCIAS_MOBILE.md).
//
...
// pra nada, só lê o Postgres (API Spec §7, v1.10) — pode ser real desde já.
