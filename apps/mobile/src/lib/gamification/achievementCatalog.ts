...
// vs TypeScript), então isso é conferido manualmente por enquanto. Espelha
// apps/web/src/lib/gamification/achievementCatalog.ts (só o campo `icon` difere: aqui é
